...
tags:
  ...
  - Evasion
Descripción: "Process injection es escribir código propio en la memoria de otro proceso y ejecutarlo ahí — para una shell, código residente en memoria, o *hooking* de funciones"
