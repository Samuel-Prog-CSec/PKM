...
> Los envenenadores se cazan con *honeypot queries* (pedir un hostname inexistente: si alguien responde, hay un Responder en la red) y con MDI. Ojo con el mito: **LLMNR, NBT-NS y mDNS siguen activados por defecto** en Windows 10/11 —en las builds recientes de Windows 11 mDNS es incluso el mecanismo de resolución primario—, así que el ataque continúa plenamente vigente; deshabilitarlos es un *hardening* que se aplica por GPO, no un valor por defecto. Opsec y telemetría en [[25 - Detección y evasión en AD]].
