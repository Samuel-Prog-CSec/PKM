...
> Dentro del bosque, la vía es el SID History ([[21 - Ataque a trust hijo a padre]]). Entre bosques, con SID filtering activo, el vector son <mark style="background: #FFB8EBA6;">kerberoasting a través del trust, membresías foráneas y reutilización de credenciales</mark>. Si el SID filtering estuviera desactivado (raro, pero se ve), el ExtraSid también funcionaría cross-forest. BloodHound marca las aristas entre bosques que llevan a acceso.
