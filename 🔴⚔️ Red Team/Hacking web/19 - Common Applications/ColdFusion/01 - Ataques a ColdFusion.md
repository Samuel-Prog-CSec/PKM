...
> Lo anterior es CF8 (viejo). En despliegues actuales, hay dos críticas de 2023 con **mecanismos distintos** (no confundirlas): <mark style="background: #FF5582A6;">**CVE-2023-26360** es *improper access control* (CWE-284) — lectura de ficheros arbitraria que deriva en RCE</mark>, explotada activamente ([CISA KEV](https://www.cisa.gov/known-exploited-vulnerabilities-catalog), ataques a infraestructura gubernamental en 2023); la RCE **no autenticada por deserialización (WDDX)** es otra CVE distinta: **CVE-2023-26359** (mismo boletín APSB23-25) y **CVE-2023-29300** (APSB23-40, julio 2023), ambas CVSS 9.8, en CF 2018/2021; y **CVE-2024-20767** (lectura de ficheros). Herramientas: `searchsploit`, `nuclei -tags coldfusion`, módulos `exploit/multi/http/coldfusion_*` de Metasploit.
