...
[![Licencia: CC BY-NC-SA 4.0|177](https://img.shields.io/badge/Licencia-CC%20BY--NC--SA%204.0-blue.svg?logo=creativecommons&logoColor=white)](LICENSE)
...
Está estructurado como un [Zettelkasten](https://es.wikipedia.org/wiki/Zettelkasten): cada nota es atómica, trata un único concepto y se enlaza con sus vecinas. Los índices son archivos `.base` (Obsidian Bases), no notas MOC manuales.
