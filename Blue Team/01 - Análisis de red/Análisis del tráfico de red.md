...
tags:
  ...
  - Sniffing
  - Introduccion
Descripción: "Network Traffic Analysis (NTA) puede describirse como el acto de examinar el tráfico de la red para caracterizar los puertos y protocolos comunes utilizados, establecer una…"
Fecha de actualización: 2025-10-20
Nota previa: 
Nota siguiente: "[[Tipos de análisis de red]]"
Area: "[[Análisis de red.base|Análisis de red]]"
---
---
...
Identificar puertos y [[Introducción a los protocolos de red|Protocolos de red]]] estándar rápidamente y tener una comprensión funcional de cómo se comunican garantizará que podamos identificar tráfico de red potencialmente malicioso o mal formado.
