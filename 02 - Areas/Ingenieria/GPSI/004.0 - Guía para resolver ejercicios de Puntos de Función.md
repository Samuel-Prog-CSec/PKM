...
> **Todo lo que necesitas para resolver el ejercicio de Puntos de Función** del examen (calcular el **PFSA** a partir de los requisitos de una aplicación), paso a paso. Lo que no haga falta para el ejercicio queda fuera. Practica con [[004.1 - Ejercicio PF - Eventos fantásticos]] y [[004.2 - Ejercicio PF - Hospital COVID-19]], y ponte a prueba con [[004.3 - Test y ejercicios de práctica (examen)]].
