...
tags:
  ...
  - Go/Windows
  - Tipo/Introduccion
Descripción: "Atacar Windows desde Go pasa por hablar con la Windows API: las funciones que exportan las DLLs del sistema (kernel32.dll, user32.dll, advapi32.dll)"
