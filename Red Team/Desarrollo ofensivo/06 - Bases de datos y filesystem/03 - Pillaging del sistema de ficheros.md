...
Descripción: "El último tool del capítulo saquea el disco: recorre un árbol de directorios buscando ficheros jugosos — claves SSH, .env, bases de KeePass, credenciales de cloud, ficheros de…"
Fecha de actualización: 2026-07-24
Nota previa: "[[02 - Data mining - buscar datos jugosos]]"
Nota siguiente: "[[04 - Parsear salidas de herramientas a CSV y JSON]]"
...
Con esto cubres el manejo de datos: SQL y MongoDB con drivers modernos, minado de esquemas con una interfaz elegante y saqueo del disco. Un último eslabón de datos estructurados antes de bajar a la red — consumir la salida de tus herramientas (Nmap, testssl) y volcarla a un informe → [[04 - Parsear salidas de herramientas a CSV y JSON]].
