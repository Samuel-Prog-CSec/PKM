...
tags:
  ...
  - Protocolos
  - Windows
Descripción: "SMB (*Server Message Block*) es un protocolo cliente-servidor que regula el acceso a ficheros, directorios y otros recursos de red (impresoras, interfaces compartidas) y también…"
