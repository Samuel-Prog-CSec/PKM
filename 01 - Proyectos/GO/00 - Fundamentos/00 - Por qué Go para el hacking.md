...
- **Concurrencia nativa.** Las *goroutines* y los *channels* (ver [[13 - Goroutines y channels]]) hacen que un escáner concurrente de miles de puertos quepa en 20 líneas. El modelo se diseñó para multicore desde el principio.
