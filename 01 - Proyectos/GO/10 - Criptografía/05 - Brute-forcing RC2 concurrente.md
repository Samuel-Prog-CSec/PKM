...
Con esto cierras el bloque de criptografía: hashing, HMAC, simétrico, asimétrico, mTLS y fuerza bruta concurrente. El siguiente tema baja al sistema operativo — interacción con Windows y análisis de PE → carpeta `11 - Windows y PE`.
